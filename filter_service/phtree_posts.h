...
class PhTreePostsDB {
  ...
  public:
    ...
    std::vector<PostID> get_hot_posts(Filter f) {
        ...
        std::cout << "Latitude:    " << f.latitude << std::endl;
        std::cout << "Longitude:   " << f.longitude << std::endl;
        std::cout << "Channel1:    " << f.channel1 << std::endl;
        std::cout << "Channel2:    " << f.channel2 << std::endl;
        std::cout << "Range:       " << f.range << std::endl;
        std::cout << "MinResults:  " << f.minresults << std::endl;

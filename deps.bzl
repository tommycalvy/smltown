...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:7I86bWNQB+HGDT5z/dJy61J7qgbgLoZ7O51C9eL6hrA=",
        version = "v1.44.100",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:b9LGqNnOdg9vR4Q43tBTVWk4J6F+W774MSchvKJsqnE=",
        version = "v1.17.8",
    )
    go_repository(
        ...
        sum = "h1:4tjlyCD0hRGNQivh5dN8hbP30qQhMLBE/FgQR1vHHWM=",
        version = "v1.12.21",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:1QpTkQIAaZpR387it1L+erjB5bStGFCJRvmXsodpPEU=",
        version = "v1.17.1",
    )
    go_repository(
        ...
        sum = "h1:V9q4A0qnUfDsfivspY1LQRQTOG3Y9FLHvXIaTbcU7XM=",
        version = "v1.13.20",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:o0Ia3nb56m8+8NvhbCDiSBiZRNUwIknVWobx5vks0Vk=",
        version = "v1.7.17",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:OwhhKc1P9ElfWbMKPIbMMZBV6hzJlL2JKD76wNNVzgQ=",
        version = "v1.13.6",
    )
    go_repository(
